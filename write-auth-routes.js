...
console.log('✓ auth.routes.js written cleanly');
console.log('  No missing dependencies');
console.log('  Endpoints: /register, /login-mpin, /login, /validate');

// Verify no bad requires
const written = fs.readFileSync(target, 'utf8');
const badRequires = ['device.service', 'user.service', 'otp.service'];
badRequires.forEach(dep => {
  if (written.includes(dep)) {
    console.log('✗ BAD: still references ' + dep);
  }
});
console.log('✓ No missing service dependencies found');